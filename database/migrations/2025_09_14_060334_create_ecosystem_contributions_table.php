...
return new class extends Migration
{
    ...
    {
        Schema::create('ecosystem_contributions', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('status');
            $table->index(['ecosystem_id', 'user_id'], 'ecosystem_contributions_ecosystem_user_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('ecosystem_contributions');
    }
};
