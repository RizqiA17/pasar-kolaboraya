    ...
    <div class="relative z-10 p-6">
        ...
        @if(!$hasResponded)
            <a href="{{ route('survey.participate') }}"
                wire:click="participateInSurvey"
                class="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-4 py-2 rounded-lg font-medium hover:from-emerald-600 hover:to-teal-700 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
                Ikuti Survey
            </a>
        @else
