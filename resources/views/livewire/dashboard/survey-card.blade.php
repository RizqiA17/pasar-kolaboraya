    ...
    @if ($activeSurvey)
        <div
            ...
            <div class="absolute top-0 right-0 w-20 h-20 opacity-10">
                <img src="{{ Storage::url('web/ASET VISUAL/SVG/9.svg') }}" alt=""
            ...
            <div class="relative z-10 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if ($hasResponded)
                        <span
                            class="px-3 py-1 bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 text-xs font-medium rounded-full">
                            Sudah Diisi
                        </span>
                    @else
                        <span
                            class="px-3 py-1 bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200 text-xs font-medium rounded-full">
                            Belum Diisi
                        </span>
                    @endif
                </div>
