<div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white to-purple-50 dark:from-zinc-800 dark:to-purple-900/20 shadow-xl border border-gray-100 dark:border-gray-700 p-8">
    {{-- SVG Accent Elements --}}
    ...
    <div class="relative z-10">
        <div class="flex items-center justify-between mb-6 flex-wrap">
            ...
            <flux:button href="{{ route(name: 'settings.profile-settings') }}" variant="subtle" size="sm" class="bg-gradient-to-r from-purple-100 to-pink-100 hover:from-purple-200 hover:to-pink-200 text-purple-700 border-purple-200">
        ...
        @if ($profile)
            ...
            <div class="space-y-4 mb-8">
                @if ($profile->organization)
                    <div class="flex items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl border border-blue-100 dark:border-blue-800">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-semibold text-blue-900 dark:text-blue-100">{{ $profile->organization }}</div>
                        </div>
                    </div>
                @endif
                ...
                @if ($profile->phone)
                    <div class="flex items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl border border-green-100 dark:border-green-800">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-semibold text-green-900 dark:text-green-100">{{ $profile->phone }}</div>
                        </div>
                    </div>
                @endif
                ...
                @if ($profile->vision)
                    <div class="flex items-start p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl border border-purple-100 dark:border-purple-800">
                        <div class="w-10 h-10 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl flex items-center justify-center mr-4 mt-1">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @foreach ($skills->take(5) as $skill)
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 dark:from-blue-900/30 dark:to-indigo-900/30 dark:text-blue-200 border border-blue-200 dark:border-blue-700 shadow-sm">
                                {{ $skill->name }}
                        ...
                        @endforeach
                        @if ($skills->count() > 5)
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-gray-100 to-slate-100 text-gray-700 dark:from-gray-800 dark:to-slate-800 dark:text-gray-300 border border-gray-200 dark:border-gray-600 shadow-sm">
                                +{{ $skills->count() - 5 }} lagi
                            </span>
                        @endif
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @foreach ($interests->take(5) as $interest)
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 dark:from-green-900/30 dark:to-emerald-900/30 dark:text-green-200 border border-green-200 dark:border-green-700 shadow-sm">
                                {{ $interest->name }}
                            </span>
                        @endforeach
            ...
            @if ($profile->location)
                <div class="mb-6">
                    ...
                    <div class="flex items-center p-4 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl border border-orange-100 dark:border-orange-800">
                        ...
                        <div>
                            ...
                            <div class="text-lg font-semibold text-orange-900 dark:text-orange-100">{{ $profile->location }}</div>
                        </div>
                    </div>
                </div>
            @endif
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">Buat profil Anda untuk memulai perjalanan kolaborasi</p>
                <flux:button href="{{ route(name: 'settings.profile-settings') }}" variant="primary" class="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700">
                    Buat Profil
                </flux:button>
            </div>
        @endif
