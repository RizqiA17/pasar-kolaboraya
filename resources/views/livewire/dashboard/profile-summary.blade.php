<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 relative overflow-hidden">
                        ...
                        @if ($url !== '')
                            <a href="{{ $url }}" target="_blank" rel="noopener noreferrer"
                                ...
                                @switch(strtolower($platform))
                                    ...
                                    @default
                                        <svg class="h-5 w-5 mr-1.5 text-gray-500" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    @else
        ...
        <div class="text-center py-8">
            ...
            <p class="mt-1 text-sm text-gray-500">Mulai lengkapi profil Anda untuk mendapatkan pengalaman yang lebih
                baik.</p>
            <div class="mt-6">
                <flux:button href="{{ route('profile.setup') }}" variant="primary">
                    Lengkapi Profil
                </flux:button>
            </div>
        </div>
