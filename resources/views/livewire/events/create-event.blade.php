<div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <form wire:submit.prevent="save" class="p-6 space-y-8" id="eventForm" 
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-indigo-400 transition-colors duration-200">
                            <div class="text-center">
                                ...
                                <div class="mt-4">
                                    <label for="banner" class="cursor-pointer">
                                        <span class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-medium rounded-lg hover:from-indigo-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200">
                                    ...
                                    <input type="file" name="banner" id="banner" wire:model="banner" accept="image/*" class="hidden">
                                </div>
                                <p class="mt-2 text-xs text-gray-500">PNG, JPG, GIF hingga 10MB</p>
                            </div>
                        </div>
                        
                        <div wire:loading wire:target="banner" class="absolute inset-0 bg-white/80 rounded-xl flex items-center justify-center">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        <input type="text" name="title" id="title" wire:model="title" placeholder="Contoh: Workshop Design Thinking untuk Startup"
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            @error('start_date') <span class="text-red-500 text-sm flex items-center"><svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>{{ $message }}</span> @enderror
                        </div>
    ...
    @if (session()->has('message'))
        <div class="fixed bottom-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg transform transition-all duration-300 animate-bounce">
            <div class="flex items-center space-x-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
