<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700">
        <div class="p-6 border-b border-gray-200 dark:border-slate-700">
            ...
            <p class="text-sm text-gray-600 dark:text-slate-400 mt-1">Isi form di bawah ini untuk mengajukan kontribusi
                Anda</p>
        </div>
        ...
        <form wire:submit="submitContribution" class="p-6 space-y-6">
            ...
            <div>
                ...
                <select wire:model.live="contribution_id" id="contribution_id"
            ...
            @if ($isOther)
                <div>
                    <label for="contribution_custom_type"
                    ...
                    <input type="text" wire:model="contribution_custom_type" id="contribution_custom_type"
                        class="mt-1 p-4 block w-full rounded-md border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            ...
            <div>
                ...
                <textarea wire:model="contribution_description" id="contribution_description" rows="4"
                    class="mt-1 p-4 block w-full rounded-md border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Jelaskan secara detail kontribusi yang ingin Anda berikan..."></textarea>
                @error('contribution_description')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">Minimal 10 karakter, maksimal 1000 karakter
                </p>
            </div>
