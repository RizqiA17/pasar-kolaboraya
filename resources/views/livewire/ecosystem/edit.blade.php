<div class="flex flex-col gap-6 relative">
    ...
    <div class="text-center">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Ekosistem</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">Perbarui informasi ekosistem Anda</p>
    </div>
    ...
    <form wire:submit="updateEcosystem" class="flex flex-col gap-6">
        <!-- Organization Name -->
        ...
        <div class="flex flex-col gap-3">
            ...
            <flux:button type="button" variant="outline" class="w-full cursor-pointer"
                wire:click="$dispatch('redirect', { url: '{{ route('ecosystem.dashboard', $ecosystem) }}' })">
                {{ 'Batal' }}
            </flux:button>
        </div>
    </form>
