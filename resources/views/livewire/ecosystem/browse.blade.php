        ...
        @forelse($ecosystems as $ecosystem)
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center mb-4">
                        <div class="flex-shrink-0 mr-3">
                            <div class="w-8 h-8 bg-gradient-to-r from-blue-600 to-green-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600">
                    ...
                    @if(Auth::user() && $ecosystem->creator_id === Auth::id())
                        <div class="flex space-x-2">
                            <a href="{{ route('ecosystem.dashboard', $ecosystem) }}" 
                               class="flex-1 inline-flex items-center justify-center px-3 py-2 rounded-lg text-sm bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors duration-200"
                               wire:navigate>
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif($canJoin)
                        <flux:button 
                            wire:click="joinEcosystem({{ $ecosystem->id }})" 
                            variant="primary" 
                            size="sm" 
                            class="w-full"
                        >
