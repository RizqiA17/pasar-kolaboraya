<section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 bg-cream">
        @forelse ($friends as $friend)
            <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm hover:border-blue-100 hover:shadow-sm transition-all duration-200">
                <div class="flex flex-col items-center text-center">
                    <div class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-medium text-2xl shadow-inner mb-4">
                    ...
                    <div class="flex items-center gap-3 w-full">
                        {{-- <flux:button variant="outline" size="sm" class="flex-1 text-gray-700 bg-white hover:bg-gray-50 border border-gray-200 hover:border-gray-300 shadow-sm transition-all duration-150 px-3 py-2 rounded-lg">
                        ...
                        <flux:modal.trigger name="create-collaboration-{{ $friend['id'] }}" class="flex-1">
                            <flux:button variant="primary" size="sm" class="w-full bg-blue-500 hover:bg-blue-600 text-white shadow-sm hover:shadow transition-all duration-150 px-3 py-2 rounded-lg">
                                <div class="flex items-center justify-center gap-1.5">
