                                ...
                                <div class="flex items-center space-x-4 mb-3 sm:mb-0">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <span
                                            ...
                                            @if ($contribution->status === 'offered') bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-200
                                            @elseif($contribution->status === 'accepted') bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200
                                            @elseif($contribution->status === 'completed') bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200
                                            @else bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 @endif">
                                            @if ($contribution->status === 'offered') Ditawarkan
                                            @elseif($contribution->status === 'accepted') Diterima
                                            @elseif($contribution->status === 'completed') Selesai
                                            @else Ditolak @endif
                                        </span>
                                    </div>
                                </div>
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            ...
                            @else
                                Belum ada kontribusi di aksi kolektif ini.
                            @endif
                        </p>
                    </div>
                @endif
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="mt-2 -ml-2">
                                            <span
                                                ...
                                                @if ($selectedContribution->status === 'offered') bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-200
                                                @elseif($selectedContribution->status === 'accepted') bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200
                                                @elseif($selectedContribution->status === 'completed') bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200
                                                @else bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 @endif">
                                                @if ($selectedContribution->status === 'offered') Ditawarkan
                                                @elseif($selectedContribution->status === 'accepted') Diterima
                                                @elseif($selectedContribution->status === 'completed') Selesai
                                                @else Ditolak @endif
                                            </span>
                                        </div>
                                    </div>
