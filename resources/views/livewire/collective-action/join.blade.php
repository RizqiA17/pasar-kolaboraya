        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4 text-sm">
                <div>
                    ...
                    <span class="ml-2 text-gray-900 dark:text-white font-medium">{{ $collectiveAction->scale_label }}</span>
                </div>
                <div>
                    <span class="text-gray-600 dark:text-gray-400">Jangkauan:</span>
                    <span class="ml-2 text-gray-900 dark:text-white font-medium">{{ $collectiveAction->scope_label }}</span>
                </div>
                <div>
                    <span class="text-gray-600 dark:text-gray-400">Mulai:</span>
                    <span class="ml-2 text-gray-900 dark:text-white font-medium">{{ $collectiveAction->start_date->format('d M Y') }}</span>
                </div>
                <div>
                    <span class="text-gray-600 dark:text-gray-400">Selesai:</span>
                    <span class="ml-2 text-gray-900 dark:text-white font-medium">{{ $collectiveAction->end_date->format('d M Y') }}</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
            ...
            <div class="mb-6">
                ...
                <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    <p><strong>Anggota:</strong> Dapat berpartisipasi dalam aksi kolektif dan berkontribusi</p>
                    <p><strong>Kontributor:</strong> Fokus pada kontribusi spesifik tanpa menjadi anggota penuh</p>
                </div>
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-start">
                    ...
                    <span class="text-sm text-gray-700 dark:text-gray-300">
                        Saya menyetujui syarat dan ketentuan aksi kolektif ini dan siap berpartisipasi sesuai dengan peran yang diminta.
                    </span>
                </label>
            </div>
        </div>
