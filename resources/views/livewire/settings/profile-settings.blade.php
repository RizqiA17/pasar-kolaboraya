<div class="max-w-7xl mx-auto">
    ...
    <!-- Hero Header -->
    <div class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-2xl shadow-2xl mb-8">
        <div class="absolute inset-0 bg-black/10"></div>
        <div class="relative p-8 sm:p-12 text-white">
            <div class="max-w-3xl">
                <h1 class="text-3xl sm:text-4xl font-bold mb-4">Pengaturan Profil</h1>
                <p class="text-lg text-blue-100 leading-relaxed">Kelola informasi profil, minat, keahlian, dan kontribusi Anda untuk terhubung dengan kreator yang memiliki passion serupa.</p>
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-16">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <nav class="space-y-2">
                        <a href="#profile-info"
                            class="flex items-center px-4 py-3 text-sm font-medium rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 border border-blue-200 shadow-sm">
                        ...
                        <a href="#interests"
                            class="flex items-center px-4 py-3 text-sm font-medium rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 hover:text-purple-700 hover:border hover:border-purple-200 transition-all duration-200">
                            <div class="h-8 w-8 rounded-lg bg-gray-100 flex items-center justify-center mr-3 group-hover:bg-purple-100">
                        ...
                        <a href="#skills"
                            class="flex items-center px-4 py-3 text-sm font-medium rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 hover:text-green-700 hover:border hover:border-green-200 transition-all duration-200">
                            <div class="h-8 w-8 rounded-lg bg-gray-100 flex items-center justify-center mr-3 group-hover:bg-green-100">
                        ...
                        <a href="#contributions"
                            class="flex items-center px-4 py-3 text-sm font-medium rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-amber-50 hover:to-orange-50 hover:text-amber-700 hover:border hover:border-amber-200 transition-all duration-200">
                            <div class="h-8 w-8 rounded-lg bg-gray-100 flex items-center justify-center mr-3 group-hover:bg-amber-100">
                                <svg class="h-4 w-4 text-gray-600 group-hover:text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#danger"
                            class="flex items-center px-4 py-3 text-sm font-medium rounded-xl text-red-700 hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 hover:border hover:border-red-200 transition-all duration-200">
            ...
            <div id="profile-info" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-blue-100">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="inline-flex items-center rounded-full bg-blue-100 px-3 py-1 text-xs font-medium text-blue-800 ring-1 ring-inset ring-blue-200">Required</span>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <form wire:submit="updateProfileInformation" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label for="organization" class="block text-sm font-medium text-gray-900">Organisasi</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @error('organization') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                            </div>
                        ...
                        <div class="space-y-2">
                            <label for="vision" class="block text-sm font-medium text-gray-900">Visi & Misi</label>
                            <div class="relative">
                            ...
                            @error('vision') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                            ...
                            <x-action-message class="mr-3" on="profile-updated">
                                <span class="inline-flex items-center rounded-xl bg-emerald-50 px-3 py-2 text-sm font-medium text-emerald-700 ring-1 ring-inset ring-emerald-600/20">
                                    <svg class="mr-2 h-4 w-4 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                            ...
                            <label
                                ...
                                <div class="min-w-0 flex flex-col flex-1">
                                    ...
                                    @if ($interest->description)
                                        <p class="mt-2 text-xs text-gray-600 ml-8 leading-relaxed">{{ $interest->description }}</p>
                                    @endif
                                </div>
                            </label>
                        @endforeach
                            ...
                            <label
                                ...
                                <div class="min-w-0 flex flex-col flex-1">
                                    ...
                                    @if ($skill->description)
                                        <p class="mt-2 text-xs text-gray-600 ml-8 leading-relaxed">{{ $skill->description }}</p>
                                    @endif
                                </div>
                            </label>
                        @endforeach
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Tindakan ini tidak dapat dibatalkan. Harap berhati-hati.</p>
                            </div>
                        </div>
                        <span class="inline-flex items-center rounded-full bg-red-100 px-3 py-1 text-xs font-medium text-red-800 ring-1 ring-inset ring-red-200">Danger</span>
                    </div>
                </div>
