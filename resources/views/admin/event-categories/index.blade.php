<x-admin.layout title="Event Categories Management">
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-slate-800 dark:text-slate-200">Event Categories Management</h1>
                <p class="text-slate-600 dark:text-slate-400 mt-1">Manage all event categories in the system</p>
            </div>
