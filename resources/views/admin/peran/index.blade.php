<x-admin.layout title="Manajemen Peran">
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-slate-800 dark:text-slate-200">Manajemen Peran</h1>
                <p class="text-slate-600 dark:text-slate-400 mt-1 text-sm sm:text-base">Kelola semua peran dalam sistem</p>
            </div>
            ...
            <form method="GET" class="space-y-4">
                <div class="flex flex-col lg:flex-row gap-4">
                    ...
                    @if(request('search') || request('usage') || request('date_from') || request('date_to'))
                        <a href="{{ route('admin.peran') }}" class="px-4 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200">Hapus</a>
                    @endif
                </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="text-sm font-medium text-slate-800 dark:text-slate-200">{{ $role->nama }}</div>
                                    <div class="text-xs text-slate-500 dark:text-slate-400 mt-1 line-clamp-2">{{ Str::limit($role->deskripsi, 80) }}</div>
                                </div>
                            </div>
                ...
                @empty
                    <div class="p-8 text-center">
                        <div class="text-slate-500 dark:text-slate-400">
                            ...
                            <p class="text-lg font-medium">Tidak ada peran ditemukan</p>
                ...
                <table class="w-full">
                    <thead class="bg-slate-50 dark:bg-slate-700/50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">Deskripsi</th>
