    ...
    <div class="container mx-auto px-4 py-6 sm:py-8 w-full overflow-x-hidden">
        <div class="max-w-4xl mx-auto w-full">
            ...
            <div class="text-center mb-6 sm:mb-8">
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">QR Code Ekosistem</h1>
                <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">{{ $ecosystem->ecosystem_title }}</p>
            </div>
            ...
            <!-- Ecosystem Info -->
            <div class="mt-6 sm:mt-8 bg-gray-50 dark:bg-gray-800 rounded-xl p-4 sm:p-6 w-full overflow-hidden">
                <h3 class="text-sm sm:text-base font-semibold text-gray-800 dark:text-white mb-2 sm:mb-3">Informasi Ekosistem</h3>
