    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-2">QR Code Ekosistem</h1>
                <p class="text-gray-600 dark:text-slate-300">{{ $ecosystem->ecosystem_title }}</p>
            </div>
            ...
            <div class="mt-8 bg-gray-50 dark:bg-slate-800 rounded-lg p-6 border border-gray-200 dark:border-slate-700">
                <h3 class="font-semibold text-gray-800 dark:text-slate-200 mb-3">Informasi Ekosistem</h3>
