            ...
            <div class="mx-auto max-w-7xl space-y-6">
                        ...
                        @if (auth()->user()->canAccessEcosystem())
                            ...
                            <div
                                ...
                                <div class="relative z-10">
                                    ...
                                    <h3 class="text-sm font-bold mb-2 text-gray-900 dark:text-slate-100">Aksi Kolektif
                                    </h3>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-6 order-1 lg:order-2">
                        <!-- QR Code Card -->
                        {{-- <div
                            class="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-800 shadow-lg border border-gray-100 dark:border-slate-700">
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-900/10 dark:to-purple-900/10">
                            </div>
                            <div class="absolute top-0 right-0 w-16 h-16 opacity-10">
