    ...
    <div class="container mx-auto px-4 py-6 sm:py-8 w-full overflow-x-hidden">
        <div class="max-w-2xl mx-auto w-full">
            ...
            <div class="text-center mb-6 sm:mb-8">
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-slate-100 mb-2">QR Code Aksi Kolektif</h1>
                <p class="text-sm sm:text-base text-gray-600 dark:text-slate-300">{{ $collectiveAction->title }}</p>
            </div>
