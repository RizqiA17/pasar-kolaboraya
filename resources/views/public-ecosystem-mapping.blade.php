        ...
        <div class="container mx-auto px-4 py-8">
            @if($selectedPasar && $ecosystems->count() > 0)
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                    <!-- Header -->
                    <div class="relative overflow-hidden rounded-xl bg-white dark:bg-slate-800 shadow-lg border border-gray-100 dark:border-gray-700">
                        ...
                        <div class="relative z-10 p-6 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center shadow-lg">
            ...
            @elseif($selectedPasar && $ecosystems->count() === 0)
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            ...
            @else
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Tidak Ada Pasar Kolaboraya</h4>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">
