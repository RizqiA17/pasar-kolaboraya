    ...
    <flux:sidebar sticky stashable
        ...
        <flux:navlist variant="outline" class="space-y-2">
            <flux:navlist.item icon="folder-git-2" href="https://github.com/laravel/livewire-starter-kit"
                target="_blank"
                class="text-gray-700 hover:text-emerald-600 hover:bg-emerald-200 dark:text-gray-200 dark:hover:text-emerald-300 dark:hover:bg-emerald-700 transition-all duration-200">
                {{ __('Repository') }}
            </flux:navlist.item>

            <flux:navlist.item icon="book-open-text" href="https://laravel.com/docs/starter-kits#livewire"
                target="_blank"
                class="text-gray-700 hover:text-teal-600 hover:bg-teal-200 dark:text-gray-200 dark:hover:text-teal-300 dark:hover:bg-teal-700 transition-all duration-200">
                {{ __('Documentation') }}
            </flux:navlist.item>
        </flux:navlist>
        ...
        <flux:dropdown class="hidden lg:block" position="bottom" align="start">
            ...
            <flux:menu
                class="w-[220px] bg-white border border-blue-200 dark:bg-gray-800 dark:border-blue-600 shadow-lg">
                <flux:menu.radio.group>
                    <div class="p-0 text-sm font-normal">
                        <div class="flex items-center gap-2 px-1 py-1.5 text-start text-sm">
                            <span class="relative flex h-8 w-8 shrink-0 overflow-hidden rounded-lg">
