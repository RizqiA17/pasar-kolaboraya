        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="link" :href="route('connections')"
                    :current="request()->routeIs('connections')" wire:navigate>{{ __('Koneksi') }}</flux:navlist.item>
                <flux:navlist.item icon="users" :href="route('collaborations')"
                    :current="request()->routeIs('collaborations')" wire:navigate>{{ __('Kolaborasi') }}
                </flux:navlist.item>
