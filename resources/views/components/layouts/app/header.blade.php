...
<body class="min-h-screen bg-primary-light-blue block! dark:bg-gray-950/80">
    ...
    <flux:header
        class="sticky top-0 z-50 border-b bg-cream/80 border-white/20 dark:bg-zinc-950/80! backdrop-blur-xl shadow-2xl shadow-blue-500/10 dark:shadow-none grid! grid-cols-3!">
