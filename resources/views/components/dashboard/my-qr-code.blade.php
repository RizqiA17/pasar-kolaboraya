<div
    class="col-span-1 mt-auto flex group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-lg dark:border-t! dark:border-slate-700 h-44 p-6 max-h-full flex-col">
    ...
    <flux:link wire:navigate href="{{ route('qr.show') }}"
        class="inline-flex items-center text-xs font-medium transition-colors pb-2 flex-grow">
        Lihat QR Code
