<div id="ecosystem-detail-modal" class="fixed inset-0 bg-black/50 z-50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Nama Ekosistem</label>
                        <p id="ecosystem-name" class="text-gray-900 font-medium"></p>
                    </div>

                    <!-- Organization -->
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Organisasi</label>
                        <p id="ecosystem-organization" class="text-gray-900"></p>
                    </div>

                    <!-- Issues Addressed -->
                    <div class="bg-gray-50 p-4 rounded-lg md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Isu yang Diperjuangkan</label>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg md:col-span-2">
                        ...
                        <p id="ecosystem-description" class="text-gray-900 leading-relaxed"></p>
                    </div>

                    <!-- Work Region -->
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Wilayah Kerja</label>
                        <p id="ecosystem-work-region" class="text-gray-900"></p>
                    </div>

                    <!-- Member Count -->
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Jumlah Anggota</label>
                        <p id="ecosystem-member-count" class="text-gray-900 font-medium"></p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
            <button id="close-ecosystem-modal-btn" class="px-4 py-2 text-gray-600 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors">
                Tutup
            </button>
        </div>
    </div>
