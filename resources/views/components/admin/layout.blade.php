<x-layouts.app.header :title="$title ?? 'Admin Panel'">
            ...
            <div class="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
                <div class="flex flex-col flex-grow bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-r border-white/20 dark:border-slate-700/50 shadow-lg">
                    ...
                    <nav class="flex-1 px-4 pb-4 space-y-2">
                        ...
                        <div class="pt-4">
                            <h3 class="px-3 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Management</h3>
                        ...
                        <div class="pt-4">
                            <h3 class="px-3 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Master Data</h3>
                            <div class="mt-2 space-y-1">
                ...
                <div class="lg:hidden">
                    <div class="flex items-center justify-between h-16 px-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-b border-white/20 dark:border-slate-700/50">
                        <div class="flex items-center space-x-3">
                            ...
                            <h1 class="text-lg font-bold text-slate-800 dark:text-slate-200">Admin Panel</h1>
                        </div>
